...
wget --tries=3 https://github.com/SWuchterl/event-producer/archive/refs/heads/dev/scoutingAK15.tar.gz
tar xaf scoutingAK15.tar.gz
mv event-producer-dev-scoutingAK15/event_producer/cmsconnect_miniaods_scouting_Run3/{inputs,fragments} .
...
# fi
# env
export HOME=/afs/cern.ch/user/s/sewuchte
