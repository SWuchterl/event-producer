...
externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    args=cms.vstring('__GRIDPACKDIR__/gg_H_quark-mass-effects_el8_amd64_gcc11_CMSSW_13_0_23_my_GluGluH_TuneCP5_13p6TeV-powheg-pythia8_MHMASS.tgz'),
...
generator = cms.EDFilter("Pythia8ConcurrentHadronizerFilter",
        ...
        processParameters = cms.vstring(
            ...
            '25:m0 = _MHMASS.0',
            '25:onMode = off',
            '25:addChannel = 1 0.35 100 4 -4', #b
            '25:addChannel = 1 0.35 100 4 -4', #c
