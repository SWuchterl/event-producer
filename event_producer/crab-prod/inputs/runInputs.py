...
options.register('nn', -1, VarParsing.multiplicity.singleton,VarParsing.varType.int, "nn")
...
if options.inFilename:
	process.source.fileNames = cms.untracked.vstring(options.inFilename)


# process.maxEvents = cms.untracked.PSet( input = cms.untracked.int32(options.maxEvents))
process.maxEvents = cms.untracked.PSet( input = cms.untracked.int32(-1))
if options.nn:
    process.maxEvents = cms.untracked.PSet( input = cms.untracked.int32(options.nn))
